...
![云盘快速上传1](./dist/云盘快速上传1.png)
![云盘快速上传2](./dist/云盘快速上传2.png)

### 云盘JSON导入

![云盘JSON导入](./dist/云盘JSON导入.png)

### 云盘音乐管理

![云盘音乐管理](./dist/云盘音乐管理.png)
...
![云盘本地上传](./dist/云盘本地上传.png)

### 安装配置说明

![打开拓展开发者模式](./dist/打开拓展开发者模式.png)
![开启允许运行用户脚本](./dist/开启允许运行用户脚本.png)
![检查程序是否运行](./dist/检查程序是否运行.png)

## 🚀 使用方法

1. 安装油猴插件（Tampermonkey）
2. 安装本脚本 [![安装脚本](https://img.shields.io/badge/-%E5%AE%89%E8%A3%85%E8%84%9A%E6%9C%AC-blue)](https://raw.githubusercontent.com/520Qiuyu/CloudMusic-Public/main/dist/cloudmusic.user.js)
...
| ![微信支付收款码](./dist/微信收款码.jpg) | ![支付宝支付收款码](./dist/支付宝收款码.jpg) |
| :-------------------------------------------------: | :-----------------------------------------------------: |
|                    **微信支付**                     |                     **支付宝支付**                      |
